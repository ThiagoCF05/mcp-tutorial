...
DB_PATH = "/Users/thiagocastroferreira/Desktop/kubernetes/mcp-tutorial/dfp_cvm.db"
...
@function_tool
def cvm_dfp_base_query(inp: QueryInput) -> dict:
    """Consultar um Banco de Dados SQL de Formulários de Demonstrações Financeiras Padronizadas (DFP) do Mercado de Ações Brasileiro com o seguinte esquema:

    CREATE TABLE IF NOT EXISTS DFP_CVM (
